...
const { User, Organization, Metric } = require("../models");
...
const standardMetrics = [
  ...
  },
  {
    ...
    description:
      "Indirect GHG emissions from purchased electricity, heat, and steam",
    category: "environmental",
    subcategory: "emissions",
    unit: "tonnes CO2e",
    frameworks: [
  ...
  },
  {
    ...
    subcategory: "water",
    unit: "cubic meters",
    frameworks: [{ name: "GRI", identifier: "GRI 303-5" }],
    dataType: "number",
    isCustom: false,
  },
  ...
  },
  {
    ...
    subcategory: "labor",
    unit: "percentage",
    frameworks: [{ name: "GRI", identifier: "GRI 401-1" }],
    dataType: "percentage",
    isCustom: false,
  },
  ...
  // Governance metrics
  {
    ...
    subcategory: "board",
    unit: "percentage",
    frameworks: [{ name: "SASB", identifier: "Varies by industry" }],
    dataType: "percentage",
    isCustom: false,
  },
  {
    ...
    subcategory: "ethics",
    unit: "",
    frameworks: [{ name: "GRI", identifier: "GRI 102-16" }],
    dataType: "boolean",
    isCustom: false,
  },
];
